    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            do
            {
                ...
                fibonacciNums.Add(y);
                x = y + z;
                fibonacciNums.Add(x);//storing fibonacci sequence #s in list
            } while (x < 1000000000); //trading the val
            ...
            {
                if (lengths.All(b => b.Length < 11))//x evaluates to all items in List "lengths"  where the length is less than 11
